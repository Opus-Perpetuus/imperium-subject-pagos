...
WORKDIR /app
LABEL org.opencontainers.image.source="https://github.com/Opus-Perpetuus/imperium-subject-pagos"
LABEL org.opencontainers.image.url="https://github.com/Opus-Perpetuus/imperium-subject-pagos"
...
COPY src ./src
ENV PORT=3000 \
    SUBJECT_TECHNICAL_ID=subject-pagos \
    KIRLET_TECHNICAL_ID=subject-pagos \
    DATA_DIR=/data \
    SUBJECT_AUTH=on \
    KIRLET_AUTH=on
